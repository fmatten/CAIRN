...
CAIRN is an Iscad GmbH software package for clinical informatics, data governance and interoperability-related workflows.

This Codeberg repository is intended as the public source and/or historical anchor for the CAIRN concept, licensing setup, contribution rules and release metadata.

## Licensing

CAIRN is offered under a dual-license model:
...
CAIRN is provided as a research and clinical informatics software component. It is **not certified as a medical device under Regulation (EU) 2017/745 (MDR)** unless a specific certified distribution or deployment context explicitly states otherwise.
